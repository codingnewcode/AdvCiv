...
// <!-- custom: Preserve the actual attacked plot for SASGameRecord because a dead attacker still occupies its origin when combatResult fires. Python retains its established winner/loser event contract. See KI#377. (ChatGPT-5.6-Sol) -->

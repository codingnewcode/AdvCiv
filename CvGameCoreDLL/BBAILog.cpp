...
// <!-- custom: Dedicated spaceship-production diagnostics so project valuation/fit and project interruption can be investigated without broad PLAYER/CITY logging. (GPT-5.6-Sol) -->
